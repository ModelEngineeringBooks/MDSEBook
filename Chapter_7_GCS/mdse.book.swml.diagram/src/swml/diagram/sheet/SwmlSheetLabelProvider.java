...
import swml.diagram.navigator.SwmlNavigatorGroup;
...
public class SwmlSheetLabelProvider extends BaseLabelProvider implements
	...
	public String getText(Object element) {
		...
		if (element instanceof SwmlNavigatorGroup) {
			return ((SwmlNavigatorGroup) element).getGroupName();
		}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = SwmlVisualIDRegistry.getVisualID(view);
			IElementType etype = SwmlElementTypes.getElementType(vid);
			if (etype != null) {
				return etype;
			}
