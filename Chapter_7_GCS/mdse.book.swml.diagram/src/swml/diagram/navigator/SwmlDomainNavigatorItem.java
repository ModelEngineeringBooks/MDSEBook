	...
	static {
		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof swml.diagram.navigator.SwmlDomainNavigatorItem) {
					swml.diagram.navigator.SwmlDomainNavigatorItem domainNavigatorItem = (swml.diagram.navigator.SwmlDomainNavigatorItem) adaptableObject;
		...
		}, swml.diagram.navigator.SwmlDomainNavigatorItem.class);
	}
