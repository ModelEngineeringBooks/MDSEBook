...
public class SwmlVisualIDRegistry {
	...
	*/
	public static int getVisualID(View view) {
		...
		return swml.diagram.part.SwmlVisualIDRegistry.getVisualID(view.getType());
	}
	...
	*/
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (SwmlPackage.eINSTANCE.getWebModel().isSuperTypeOf(domainElement.eClass())
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = swml.diagram.part.SwmlVisualIDRegistry.getModelID(containerView);
		if (!WebModelEditPart.MODEL_ID.equals(containerModelID) && !"swml".equals(containerModelID)) { //$NON-NLS-1$
			return -1;
		}
		int containerVisualID;
		if (WebModelEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = swml.diagram.part.SwmlVisualIDRegistry.getVisualID(containerView);
		} else {
		...
		case WebModelEditPart.VISUAL_ID:
			if (SwmlPackage.eINSTANCE.getHypertextLayer().isSuperTypeOf(domainElement.eClass())) {
				return HypertextLayerEditPart.VISUAL_ID;
			}
			if (SwmlPackage.eINSTANCE.getContentLayer().isSuperTypeOf(domainElement.eClass())) {
				return ContentLayerEditPart.VISUAL_ID;
			}
			break;
		case HypertextLayerHypertextLayerPagesCompartmentEditPart.VISUAL_ID:
			if (SwmlPackage.eINSTANCE.getIndexPage().isSuperTypeOf(domainElement.eClass())) {
				return IndexPageEditPart.VISUAL_ID;
			}
			if (SwmlPackage.eINSTANCE.getDetailsPage().isSuperTypeOf(domainElement.eClass())) {
				return DetailsPageEditPart.VISUAL_ID;
			}
			if (SwmlPackage.eINSTANCE.getStaticPage().isSuperTypeOf(domainElement.eClass())) {
				return StaticPageEditPart.VISUAL_ID;
			}
			break;
		case ContentLayerContentLayerClassesCompartmentEditPart.VISUAL_ID:
			if (SwmlPackage.eINSTANCE.getClass_().isSuperTypeOf(domainElement.eClass())) {
	...
	*/
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case ContentLayerEditPart.VISUAL_ID:
			if (ContentLayerNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
	...
	*/
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (SwmlPackage.eINSTANCE.getNCLink().isSuperTypeOf(domainElement.eClass())) {
			return NCLinkEditPart.VISUAL_ID;
		}
		if (SwmlPackage.eINSTANCE.getCLink().isSuperTypeOf(domainElement.eClass())) {
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return swml.diagram.part.SwmlVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return swml.diagram.part.SwmlVisualIDRegistry.checkNodeVisualID(containerView, domainElement, candidate);
		}
		...
		*/
		...
		public boolean isCompartmentVisualID(int visualID) {
			return swml.diagram.part.SwmlVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		*/
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return swml.diagram.part.SwmlVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
