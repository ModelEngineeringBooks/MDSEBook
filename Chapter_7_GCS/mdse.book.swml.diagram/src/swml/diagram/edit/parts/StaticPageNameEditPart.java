 ...
 * @generated
 */
public class StaticPageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StaticPageNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SwmlParserProvider.getParser(SwmlElementTypes.StaticPage_3003, getParserElement(),
					SwmlVisualIDRegistry.getType(swml.diagram.edit.parts.StaticPageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
