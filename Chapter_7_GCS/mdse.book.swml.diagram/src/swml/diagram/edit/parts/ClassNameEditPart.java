...
public class ClassNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SwmlParserProvider.getParser(SwmlElementTypes.Class_3004, getParserElement(),
					SwmlVisualIDRegistry.getType(swml.diagram.edit.parts.ClassNameEditPart.VISUAL_ID));
		}
		return parser;
	}
