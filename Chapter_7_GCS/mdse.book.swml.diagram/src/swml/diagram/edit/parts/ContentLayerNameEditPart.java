 ...
 * @generated
 */
public class ContentLayerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContentLayerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SwmlParserProvider.getParser(SwmlElementTypes.ContentLayer_2002, getParserElement(),
					SwmlVisualIDRegistry.getType(swml.diagram.edit.parts.ContentLayerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
