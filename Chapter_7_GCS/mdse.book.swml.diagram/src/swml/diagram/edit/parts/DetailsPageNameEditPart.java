 ...
 * @generated
 */
public class DetailsPageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DetailsPageNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SwmlParserProvider.getParser(SwmlElementTypes.DetailsPage_3002, getParserElement(),
					SwmlVisualIDRegistry.getType(swml.diagram.edit.parts.DetailsPageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
