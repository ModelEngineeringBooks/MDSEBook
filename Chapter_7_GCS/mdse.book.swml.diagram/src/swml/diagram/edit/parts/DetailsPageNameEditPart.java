 ...
 * @generated
 */
public class DetailsPageNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SwmlTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new WebModelEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SwmlParserProvider
					.getParser(
							SwmlElementTypes.DetailsPage_3002,
							getParserElement(),
							SwmlVisualIDRegistry
									.getType(swml.diagram.edit.parts.DetailsPageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					SwmlEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
