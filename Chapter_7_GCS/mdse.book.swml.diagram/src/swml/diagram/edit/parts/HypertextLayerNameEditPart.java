...
import swml.diagram.edit.policies.SwmlTextSelectionEditPolicy;
 ...
 * @generated
 */
public class HypertextLayerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HypertextLayerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new SwmlTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return SwmlElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SwmlParserProvider.getParser(SwmlElementTypes.HypertextLayer_2001, getParserElement(),
					SwmlVisualIDRegistry.getType(swml.diagram.edit.parts.HypertextLayerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, SwmlEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
