 ...
 * @generated
 */
public class IndexPageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IndexPageNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = SwmlParserProvider.getParser(SwmlElementTypes.IndexPage_3001, getParserElement(),
					SwmlVisualIDRegistry.getType(swml.diagram.edit.parts.IndexPageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
