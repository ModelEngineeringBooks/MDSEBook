...
public class SWMLGrammarAccess extends AbstractGrammarElementFinder {
	...
	private final TerminalRule tResultsPerPage;
	private final ContentLayerElements pContentLayer;
	private final ClassElements pClass;
	private final AttributeElements pAttribute;
	private final SWMLTypesElements unknownRuleSWMLTypes;
	...
	public SWMLGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tResultsPerPage = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "resultsPerPage");
		this.pContentLayer = new ContentLayerElements();
		this.pClass = new ClassElements();
		this.pAttribute = new AttributeElements();
		this.unknownRuleSWMLTypes = new SWMLTypesElements();
	}
	
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		Grammar grammar = grammarProvider.getGrammar(this);
		while (grammar != null) {
			if ("mdse.book.SWML".equals(grammar.getName())) {
				return grammar;
			}
